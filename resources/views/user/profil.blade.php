    ...
    <div class="col-lg-12">
        <div class="box">
            <form action="{{ route('user.update_profil') }}" method="post" class="form-profil" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="alert alert-danger alert-dismissible" style="display: none;" id="error-alert">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <i class="icon fa fa-ban"></i> <span id="error-message"></span>
</div>
            </form>
        </div>
    </div>
            ...
            .fail(errors => {
                if (errors.status == 422) {
                    ...
                    if (errors.responseJSON && errors.responseJSON.message) {
                        ...
                        // Jika error dari validasi Laravel
